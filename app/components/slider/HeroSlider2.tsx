...
export default function HeroSlider2(): JSX.Element {
    // is dark hook
    const isDark = useDarkModeCheck();

    return (
        <>
            <div className="swiper-container mainslider home3 auctions">
                    ...
                    >
                            ...
                            <div className="swiper-slide">
                                <div className="slider-item">
                                    <div className="ibthemes-container flex">
                                        <div className="wrap-heading flat-slider h3">
                        ...
                        <SwiperSlide>
                            ...
                            <div className="swiper-slide">
                                <div className="slider-item">
                                    <div className="ibthemes-container ">
                                        <div className="wrap-heading flat-slider flex three">
                                            <div className="image">
                                                <Image
                                                    height={448}
                                                    width={620}
