...
export default function Search2(): JSX.Element {
  const [isSearchBarActive, setSearchBarActive] = useState<boolean>(false);
  return (
    <>
      <div className="header-search flat-show-search" id="s1">
        <a
          onClick={() => setSearchBarActive(!isSearchBarActive)}
        ...
        <div className={`top-search ${isSearchBarActive ? "show" : ""}`}>
