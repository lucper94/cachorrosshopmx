...
import ProductCard10 from "../card/ProductCard10";
import Link from "next/link";

export default function LiveAuction5(): JSX.Element {
    return (
        <>
            <section className="tf-section live-auctions home4">
