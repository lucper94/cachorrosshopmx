...
export default function CreateSellNft2(): JSX.Element {
    return (
        <>
                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-4 col-md-12">
                            <div className="heading-live-auctions style2 mg-t-3 mg-bt-22">
                                ...
                                <h2
                                    className="tf-title text-left pb-15"
                                ...
                                <p className="content">
                                    ...
                                    adipiscing elit. Sollicitudin morbi donec
                                    venenatis sed eget pellentesque viverra ut.
                                    Elementum nam praesent mauris auctor amet,
                                    pulvinar adipiscing ultricies ut. Id
                                    dignissim tristique ultrices arcu tempor.
                        ...
                        <div className="col-xl-8 col-lg-8 col-md-12">
                            <div className="sc-box-icon-inner style3">
                                ...
                                <div className="sc-box-icon style2">
                                    <div className="image">
                                        <svg
                                            width={60}
                                            height={60}
                                    ...
                                    <div className="wrap-box">
                                        ...
                                        <p className="content">
                                            ...
                                            guide explains how to set up your
                                            first collection
                                        </p>
                                    </div>
                                </div>
                                <div className="sc-box-icon">
                                    ...
                                    <div className="wrap-box">
                                        ...
                                        <p className="content">
                                            ...
                                            account at this point, but very few
